...
public class fragment_tinhyeu extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tinhyeu,container,false);
        recyclerView =view.findViewById(R.id.rcv_tinhyeu);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Tình yêu").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
