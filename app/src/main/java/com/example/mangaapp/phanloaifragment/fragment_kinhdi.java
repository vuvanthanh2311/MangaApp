...
public class fragment_kinhdi extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_kinhdi,container,false);
        recyclerView =view.findViewById(R.id.rcv_kinhdi);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Kinh dị").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
