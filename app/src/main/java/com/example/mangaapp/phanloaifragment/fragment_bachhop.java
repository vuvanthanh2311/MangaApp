...
public class fragment_bachhop extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_bachhop,container,false);
        recyclerView =view.findViewById(R.id.rcv_bachhop);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Bách hợp").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
