...
public class fragment_dammy extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_dammy,container,false);
        recyclerView =view.findViewById(R.id.rcv_dammy);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Đam mỹ").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
