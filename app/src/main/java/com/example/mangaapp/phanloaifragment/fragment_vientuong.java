...
public class fragment_vientuong extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_vientuong,container,false);
        recyclerView =view.findViewById(R.id.rcv_vientuong);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Viễn tưởng").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
