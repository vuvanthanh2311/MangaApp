...
public class fragment_maohiem extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_maohiem,container,false);
        recyclerView =view.findViewById(R.id.rcv_maohiem);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Mạo hiểm").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
