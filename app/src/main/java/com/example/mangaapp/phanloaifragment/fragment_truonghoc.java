...
public class fragment_truonghoc extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_truonghoc,container,false);
        recyclerView =view.findViewById(R.id.rcv_truonghoc);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Trường học").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
