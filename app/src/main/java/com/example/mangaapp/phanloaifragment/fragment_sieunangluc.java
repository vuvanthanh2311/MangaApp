...
public class fragment_sieunangluc extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_sieunangluc,container,false);
        recyclerView =view.findViewById(R.id.rcv_sieunangluc);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Siêu năng lực").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
