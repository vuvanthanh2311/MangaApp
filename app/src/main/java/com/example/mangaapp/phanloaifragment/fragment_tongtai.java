...
public class fragment_tongtai extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tongtai,container,false);
        recyclerView =view.findViewById(R.id.rcv_tongtai);
    ...
    private void GetData(){
        ...
        mData.child("category").child("Tổng tài").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
